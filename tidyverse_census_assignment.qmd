...
myapikey <- "f2002109760dfbbb9a1af10a5ed559ece820f0e8"
...
First, I found the variable for people who speak spanish very well by searching speak spanish in the whole dataset. 

```{r}

five_seventeen_yo <- get_acs(geography = "county", 
        variables = medage,
        state = "MD") %>%
filter(estimate == 5-17)
